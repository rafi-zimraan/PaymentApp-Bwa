...
TextStyle subTextStyle = GoogleFonts.poppins(
    color: Color(0xff899788), fontWeight: FontWeight.w300, fontSize: 16);

TextStyle titleProTextStyle = GoogleFonts.poppins(
    color: Color(0xff0007DFF), fontWeight: FontWeight.bold, fontSize: 26);

TextStyle planTextStyle = GoogleFonts.poppins(
    color: whiteColor, fontWeight: FontWeight.w500, fontSize: 14);

TextStyle desTextStyle = GoogleFonts.poppins(
